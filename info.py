...
# Bot information
SESSION = environ.get('SESSION', 'Get_files123Bot')
API_ID = int(environ.get('API_ID', '26268094'))
API_HASH = environ.get('API_HASH', 'd6641aeab68305b09cbcf032360dddfc')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002235723667'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6387511841').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002241330229 -1001722984461').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002097349002') # give your force subscribe channel id here else leave it blank
